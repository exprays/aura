...
import { Aura, Category } from "@prisma/client";
                ...
                >
                        ...
                        <FormField 
                            ...
                            render={({ field }) => (
                                <FormItem className="col-span-2 md:col-span-1">
                                    ...
                                    <FormDescription>
                                        This is how your aura will be named
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                    ...
                    <div className="space-y-2 w-full">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Detailed instructions for your aura AI behaviour
                            </p>
                        </div>
                        <Separator className="bg-primary/10"/>
                    </div>
                        ...
                        <FormField 
                            ...
                            render={({ field }) => (
                                <FormItem className="col-span-2 md:col-span-1">
                                    ...
                                    <FormDescription>
                                        Describe your Aura&apos;s behaviour on user Interaction!
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
